package com.moe.spyl.login.presentation.components
    ...
    Column {
        ...
        OutlinedTextField(
            ...
            keyboardActions = KeyboardActions(onDone = {
                if (isCanContinue) onContinueClicked() else focusManager.clearFocus()
            }),
...
private fun LoginPasswordViewPreview() {
    SpylTheme {
        ...
        LoginPasswordView(password = password, onValueChange = {
            password = it
        })
    }
}